...
from tfagent.agent.agent_prompt_template import AgentPromptTemplate
...
from tfagent.tools.code.write_code import CodingTool
from tfagent.tools.code.write_spec import WriteSpecTool
from tfagent.tools.code.write_test import WriteTestTool
# from tfagent.tools.email.read_email import ReadEmailTool
# from tfagent.tools.email.send_email import SendEmailTool
from tfagent.tools.file.append_file import AppendFileTool
from tfagent.tools.file.list_files import ListFileTool
from tfagent.tools.file.read_file import ReadFileTool

# from tfagent.tools.google_search.google_search import GoogleSearchTool

# from tfagent.tools.searx.searx import SearxSearchTool
...
class IterationWorkflowSeed:
    ...
    def build_single_step_agent(cls, session):
        ...
        IterationWorkflowStep.find_or_create_step(session, iteration_workflow.id, "gb1",
                                                  ...
                                                  completion_prompt="Note: the UniversalReflectionTool can be used repeatedly. The UniversalReflectionTool must to be called after calling other tools.\n"
