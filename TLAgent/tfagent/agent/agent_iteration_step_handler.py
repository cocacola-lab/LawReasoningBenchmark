...
from tfagent.agent.agent_message_builder import AgentLlmMessageBuilder
from tfagent.agent.agent_prompt_builder import AgentPromptBuilder
from tfagent.agent.output_handler import ToolOutputHandler, get_output_handler
from tfagent.agent.task_queue import TaskQueue
from tfagent.agent.tool_builder import ToolBuilder
...
from tfagent.helper.token_counter import TokenCounter
...
from tfagent.models.agent_execution_permission import AgentExecutionPermission
from tfagent.models.organisation import Organisation
from tfagent.models.tool import Tool
...
from tfagent.models.workflows.iteration_workflow_step import IterationWorkflowStep
from tfagent.resource_manager.resource_summary import ResourceSummarizer
from tfagent.tools.resource.query_resource import QueryResourceTool
from tfagent.tools.thinking.tools import ThinkingTool
from tfagent.apm.call_log_helper import CallLogHelper
...
class AgentIterationStepHandler:
    ...
    def _build_tools(self, agent_config: dict, agent_execution_config: dict):
        ...
        if user_tools is not None and len(user_tools) > 0:
            for tool in user_tools:
                agent_tools.append(tool_builder.build_tool(tool))
        else:
            agent_tools.append(ThinkingTool())
