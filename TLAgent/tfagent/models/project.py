...
class Project(DBBaseModel):
    ...
    @classmethod
    def find_or_create_project(cls, session, organisation_id, project_name):
        """
            Finds or creates the project for the given organization.
            ...
            Returns:
                Project: The found or created default project.
        """
        project = session.query(Project).filter(Project.organisation_id == organisation_id,
