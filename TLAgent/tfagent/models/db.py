...
def connect_db():
    ...
    engine = create_engine(db_url,
                           pool_size=30,  # Maximum number of database connections in the pool
                           max_overflow=300,  # Maximum number of connections that can be created beyond the pool_size
